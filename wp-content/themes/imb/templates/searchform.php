<form role="search" method="get" class="search-form form-inline" action="<?php echo esc_url(home_url('/')); ?>">
  ...
  <div class="input-group">
    ...
    <span class="input-group-btn">
      <button type="submit" class="search-submit btn btn-default"><?php _e('', 'roots'); ?><img src="/lawcommission/wp-content/themes/wp-lawcom/assets/img/search-icon.gif"></button>
    </span>
  </div>
</form>
